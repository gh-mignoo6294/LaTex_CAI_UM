...
\titlespacing*{\chapter}
  ...
  {5pt}     % Abajo (Espacio antes de empezar el texto)
...
\setlength{\belowcaptionskip}{-5pt} % Reduce el espacio inferior de los captions
%---------- REFERENCIAS ----------%
\usepackage[spanish, capitalise]{cleveref}

% Opcional: Si preferís que diga "Fig." en lugar de "Figura"
% \crefname{figure}{F.}{Figuras}
% \crefname{table}{T.}{Tablas}
% \crefname{equation}{E.}{Ecuaciones}
