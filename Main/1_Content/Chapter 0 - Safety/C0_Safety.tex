...
\begin{figure}[H]
    ...
    \label{fig:riesgos_maquina}
\end{figure}
\begin{center} 
    \pshazard[hazard=highvoltage, size=1.5] % Símbolo de rayo
    %\pshazard[hazard=crush, size=1.5]        % Riesgo de atrapamiento
\end{center}
